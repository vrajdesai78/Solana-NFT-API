 ...
 * @internal
 */
export declare type PaperCreateCheckoutLinkIntentParams<TContract extends DropERC721 | DropERC1155 | SignatureDrop> = PaperCreateCheckoutLinkShardParams & (TContract extends DropERC1155 ? {
    contractArgs: {
        tokenId: string;
    };
} : TContract extends SignatureDrop ? {
    contractArgs: SignedPayload721WithQuantitySignature;
} : TContract extends DropERC721 ? {} : never);
/**
 * @internal
 */
export declare type PaperCreateCheckoutLinkIntentResult = {
    checkoutLinkIntentUrl: string;
};
/**
 * @internal
 */
export declare function createCheckoutLinkIntent<TContract extends DropERC721 | DropERC1155 | SignatureDrop>(contractId: string, params: PaperCreateCheckoutLinkIntentParams<TContract>): Promise<string>;
/**
 * @internal
 */
export declare class PaperCheckout<TContract extends DropERC721 | DropERC1155 | SignatureDrop> {
...
//# sourceMappingURL=paper-xyz.d.ts.map