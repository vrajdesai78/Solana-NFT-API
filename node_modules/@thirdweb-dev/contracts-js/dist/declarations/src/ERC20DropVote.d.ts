...
export interface ERC20DropVoteInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DOMAIN_SEPARATOR" | "allowance" | "approve" | "balanceOf" | "burn" | "checkpoints" | "claim" | "claimCondition" | "contractURI" | "decimals" | "decreaseAllowance" | "delegate" | "delegateBySig" | "delegates" | "getClaimTimestamp" | "getPastTotalSupply" | "getPastVotes" | "getVotes" | "increaseAllowance" | "multicall" | "name" | "nonces" | "numCheckpoints" | "owner" | "permit" | "primarySaleRecipient" | "setClaimConditions" | "setContractURI" | "setOwner" | "setPrimarySaleRecipient" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "verifyClaim" | "verifyClaimMerkleProof"): FunctionFragment;
