...
export interface PaymentSplitterUpgradeableInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "payee" | "payeeCount" | "release(address)" | "release(address,address)" | "released(address,address)" | "released(address)" | "shares" | "totalReleased(address)" | "totalReleased()" | "totalShares"): FunctionFragment;
